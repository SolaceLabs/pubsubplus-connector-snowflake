...
/**
* Payload mapper to map payloads from solace-snowflake to Solace.
*/
public class SolaceSnowflakeConnectorToSolacePayloadMapper extends SimpleToSolaceBinderAwarePayloadMapper {
